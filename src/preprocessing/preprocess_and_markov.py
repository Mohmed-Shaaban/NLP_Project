...
def main(conllu_path, n_examples=10, use_lemma=True):
    ...
    print(f"Vocabulary size: {V}\n")
       ...
       # بدل الطباعة، احفظ كل النتائج في ملف CSV مناسب للـ ML
    save_sentence_probs(sentences_raw[:n_examples], 
...
if __name__ == "__main__":
    conllu_file = r"C:\Users\sh777\OneDrive\Desktop\NLP_Project-main\NLP_Project-main\data\en_ewt-ud-train.conllu"
